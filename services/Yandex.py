...
class Ya:
    ...
    @decorator.benchmark
    def Objects(text, Xloc=config.X, Yloc=config.Y, radius=10, fix=1):
        try:
            rez = ''
            ...
            dxy = radius / 55  # преобразование км в угловые расстояния
