...
Fixer.add_fun('AutoTest', 'Основной класс по автотестированию всех модулей/сервисов', sclass='AutoTest')

class AutoTest:

    # Автотестирование всех классов
    Fixer.add_fun('Alltests', 'Получение списка всех функций указанного класса (включая системные)',
                  {},
