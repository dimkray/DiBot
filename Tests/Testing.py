...
Fixer.add_fun('Testing', 'Процессы тестирования сервисов/функций и самого бота', sclass='Testing')
...
Fixer.add_fun('strEqual', 'Сравнение с эталонным (для строк)',
              {'stest': 'Строка для тестирования [string]',
              'setalon': 'Строка для сравнения [string]'},
             'Результат совпадения 0..1 [float]')
